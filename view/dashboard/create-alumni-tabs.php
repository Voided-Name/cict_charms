<form method="POST" class="row">
  ...
  echo renderTextInput('alumniMName', 'alumniMName', 'Middle Name', true, '', '', 4, 12);
  echo renderTextInput('alumniSuffix', 'alumniSuffix', 'Suffix', true, '', '', 4, 12);
  ...
  echo insertAttribute(renderTextInput('alumniCPNumber', 'alumniCPNumber', 'Contact Number', true, '', '', 6, 12), "input", "maxlength='11'");
