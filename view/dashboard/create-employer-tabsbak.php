...
<form method="POST" class="row">
  <div class="col-md-4 col-sm-12" id="">
    ...
    <input type="email" class="form-control" id="employerEmail" required value="" name="employerEmail">
  </div>
  <div class="col-md-4 col-sm-12" id="">
    <label for="employerUsername" class="form-label">Username</label>
    <input type="text" class="form-control" id="employerUsername" required value="" name="employerUsername">
  </div>
  <div class="col-md-4 col-sm-12" id="">
    <label for="employerFName" class="form-label">First Name</label>
    <input type="text" class="form-control" id="" placeholder="Mark" required value="" name="employerFName">
  </div>
  <div class="col-md-4 col-sm-12" id="">
    <label for="employerMName" class="form-label">Middle Name</label>
    <input type="text" class="form-control" id="employerMName" placeholder="Santos" value="" name="employerMName">
  </div>
  <div class="col-md-4 col-sm-12" id="">
    <label for="employerLName" class="form-label">Last Name</label>
    <input type="text" class="form-control" id="employerLName" placeholder="Santos" required value="" name="employerLName">
  </div>
  <div class="col-md-4 col-sm-12" id="">
    <label for="employerSuffix" class="form-label">Suffix</label>
    <input type="text" class="form-control" id="employerSuffix" placeholder="Santos" value="" name="employerSuffix">
  </div>
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="employerStAdd" name="employerStAdd" value="">
  </div>
  <div class="col-md-6 col-sm-12" id="">
    <label for="employerCPNumber" class="form-label">Contact Number</label>
    <input type="text" class="form-control" id="employerCPNumber" placeholder="09XXXXXXXXX" maxlength="11" required value="" name="employerCPNumber">
  </div>
  <div class="col-md-6 col-sm-12" id="">
    <label for="employerBDate" class="form-label">Birth Date</label>
    <input id="employerBDate" class="form-control" type="date" required value="" name="employerBDate" />
  </div>
  ...
  <div class="col-6" id="">
    ...
    <input type="text" class="form-control" id="employerPosition" value="" name="employerPosition">
  </div>
  <div class="col-md-12 col-sm-12 container m-0 my-2">
