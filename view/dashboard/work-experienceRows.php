 ...
 * @var func $func
 */
$alumniWorkData = $func->selectall_where('alumni_work_experience', array('owner_id', '=', $_SESSION['userid']));
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" onclick="" value="<?php echo $alumniWorkInstance['id'] ?>" name="editWork">Save
                  changes</button>
                </form>
              </div>
            </div>
        ...
        <div class="modal fade" id="workDeleteModal<?php echo $x ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="submit" class="btn btn-primary" value="<?php echo $alumniWorkInstance['id'] ?>" name="deleteWork">Delete
