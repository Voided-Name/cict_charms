    ...
    <div class="sidebar-list">
      <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <li class="nav-item">
          <a class="nav-link 
<?php
if ($_SESSION['adminPage'] == "dashboard") {
  echo "active";
}
?>
...
<?php
if ($_SESSION['adminPage'] == "validateAlumni") {
  echo "active";
} ?>
...
<?php
if ($_SESSION['adminPage'] == "listUsers") {
  echo "active";
} ?>
...
" href="list-of-users.php">
            ...
            <li class="nav-item">
              <a class="nav-link 
<?php
if ($_SESSION['adminPage'] == "createAccount") {
  echo "active";
} ?>
...
" href="create-account.php">
                ...
                <span class="item-name">Create an Account</span>
              </a>
            </li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link 
<?php
if ($_SESSION['adminPage'] == "genReport") {
  echo "active";
}
?>

" aria-current="page" href="report.php">
            <i class="icon">
