        ...
        <div class="sidebar-list">
          <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <li class="nav-item">
              <a class="nav-link 
<?php
if ($_SESSION['facultyPage'] == "dashboard") {
  echo "active";
}
?>
            ...
            <li class="nav-item">
              ...
              <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                  <a class="nav-link 
               <?php
                if ($_SESSION['facultyPage'] == "postAnnouncement") {
                  echo "active";
                }
                ?> 
                " href="post-announcement.php">
                  ...
                  <a class="nav-link 
                <?php
                if ($_SESSION['facultyPage'] == "announcement") {
                  echo "active";
                }
                ?> 
            ...
            <li class="nav-item">
              ...
              <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                  <a class="nav-link 
<?php
if ($_SESSION['facultyPage'] == "profile") {
  echo "active";
}
?>
                " href="profile.php">
                ...
                <li class="nav-item">
                  <a class="nav-link 
<?php
if ($_SESSION['facultyPage'] == "manageProfile") {
  echo "active";
}
?>
