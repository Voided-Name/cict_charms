<?php
session_start();
$_SESSION['adminPage'] = "userProfile"
?>
<!doctype html>
              ...
              <div class="d-flex flex-wrap align-items-center justify-content-between">
                <div class="d-flex flex-wrap align-items-center">
                  <div class="profile-img position-relative me-3 mb-3 mb-lg-0 profile-logo profile-logo1">
                    <img src="../assets/images/avatars/avtar_1.png" alt="User-Profile" class="theme-color-default-img img-fluid rounded-pill avatar-100">
                  </div>
                  <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                    <h4 class="me-2 h4">CICT</h4>
                    <span>- ADMIN</span>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="text-center">
                        <div class="user-profile">
                          <img src="../assets/images/avatars/avtar_1.png" alt="profile-img" class="rounded-pill avatar-130 img-fluid">
                        </div>
                        <div class="mt-3">
                          <h3 class="d-inline-block">CICT</h3>
                  ...
                  <div class="card col-md-12">
                    <div class="card-body">
                      ...
                      <div class="mt-2">
                        ...
                        <p><a href="#" class="text-body"> Administrator</a></p>
                      </div>
                      <div class="mt-2">
                        <h6 class="mb-1">Contact:</h6>
                        <p><a href="#" class="text-body">090708542</a></p>
                      </div>
                    </div>
                  </div>
                </div>
