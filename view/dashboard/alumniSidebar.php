        ...
        <div class="sidebar-list">
          <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <li class="nav-item">
              <a class="nav-link 
<?php
if ($_SESSION['alumniPage'] == "dashboard") {
  echo "active";
}
?>
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
                ...
                <span class="item-name">Manage Portfolio</span>
                <i class="right-icon">
...
?>
                " href="awards.php">
                    ...
                    <span class="item-name">Awards / Accolades</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link 
<?php
if ($_SESSION['alumniPage'] == "workExp") {
  echo "active";
}
?>
                " href="work-experience.php">
                    ...
                    <i class="sidenav-mini-icon"> </i>
                    <span class="item-name">Work Experience</span>
                  </a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link 
<?php
if ($_SESSION['alumniPage'] == "vacancies") {
  echo "active";
}
?>
                " aria-current="page" href="vacancies.php">
                <i class="icon">
            ...
            <!--
                  <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="page" href="app/announcement-view.html" role="button" aria-expanded="false" aria-controls="sidebar-special">
                      <i class="icon">
                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
