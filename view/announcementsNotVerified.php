...
<body class="m-0" onload="">
    ...
    <div class="container-fluid row w-100 p-0">
      ...
      <div class="collapse navbar-collapse col-8" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="announcementsNotVerified.php">Announcements</a>
          </li>
        </ul>
        <div class="dropdown">
  ...
  <div class="container">
    ...
    <div class="container m-auto my-0 text-center d-flex align-items-center justify-content-center">
      <h1 class="fw-italic text-dark">Your Account is not yet Verified!</h1>
    </div>
    <hr>
