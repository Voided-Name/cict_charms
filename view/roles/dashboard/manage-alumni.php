<?php
session_start();
$_SESSION['facultyPage'] = "manageAlumni";
?>
<!doctype html>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Alumni Work Status</h4>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <!-- Edit Button -->
                                                        <a class="btn btn-sm btn-icon" data-bs-toggle="modal" data-bs-target="#myModal">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Alumni Invitation</h4>
